 ...
 *
 */
public class GetECMIFolderCaseImplTC extends TestCase {

	private static Log log = LogFactory.getLog( GetECMIFolderCaseImplTC.class );
	
	/**
	 * 
	 */
	public GetECMIFolderCaseImplTC() {
	 ...
	 * @param name
	 */
	public GetECMIFolderCaseImplTC(String name) {
		super(name);
