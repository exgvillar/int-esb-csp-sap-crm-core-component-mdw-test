...
public class SaveRequestLetterTaskModel implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -7117265583860694036L;
	...
	private String isLcom;
	private String isCnca;
	 ...
	 * @return the isLcom
	 */
	public String getIsLcom() {
		return isLcom;
	}
	/**
	 * @param isLcom the isLcom to set
	 */
	public void setIsLcom(String isLcom) {
		this.isLcom = isLcom;
	}
	/**
	 * @return the isCnca
	 */
	public String getIsCnca() {
		return isCnca;
	}
	/**
	 * @param isCnca the isCnca to set
	 */
	public void setIsCnca(String isCnca) {
		this.isCnca = isCnca;
	}
	/**
	 * @return the isInter
